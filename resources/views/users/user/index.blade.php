...
<div class="content">
        ...
        <div class="col-12 table-responsive">
            <div class="card">
                <div class="pl-3 card-header" style='background-color:whitesmoke' >
                    <button type="button" name="create_record" id="create_record" class="float-right btn btn-sm btn-primary mr-3"><i class="bi bi-plus-square"></i> Add User</button>
                    <h3 class="mb-0;ml:5"><span style="font-family: serif;color:black;weight:bolder"><strong>Users List</strong></span></h3>
                </div>
                ...
                <div class="card-body pt-1" >
                    ...
                    <div class='row table-responsive'>
                        <table style='width:100%'  class=" table table-bordered table-condensed mytable table-striped user_table">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Name</th>
    ...
    <div class="modal fade" id="formModal" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
        ...
        <form method="post" id="sample_form" class="form-horizontal">
            <div class="modal-header" style="background-color: lightgray; text-align: center;">
                <h5 class="modal-title" id="ModalLabel" style="color: white;">Add New User</h5>
            ...
            <div class="modal-body" style="max-height: 400px; overflow-y: auto;">
                ...
                <div class="form-group">
                    ...
                    <select name="role_id" id="role_id" class="form-control">
                        ...
                        @foreach (Spatie\Permission\Models\Role::orderBy('name')->get() as $key => $value)
    ...
    <div class="modal fade" id="attributeModal" tabindex="-1" role="dialog" aria-labelledby="attributeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: lightgray; text-align: center;">
                    <h5 class="modal-title" id="attributeModalLabel" style="color: white;">User Details</h5>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        dataTableSearch = $('.user_table').DataTable();  
        ...
        $('#sample_form').on('submit', function(event){
            ...
            if($('#action').val() == 'Add')
            {
                action_url = "{{ route('user.store_user') }}";
            }
    
            if($('#action').val() == 'Edit')
            {
                action_url = "{{ route('user.update_user') }}";
            }
        ...
        $(document).on('click', '.detail', function() {
            ...
            $.ajax({
                ...
                $('#attributeDetails1').html('<p>'+'<strong> Email:</strong>'+'<br>' + attribute.email + '</p>');
                $('#attributeDetails2').html('<p>'+'<strong> Role:</strong>'+'<br>' + rolename + '</p>');        
                $('#attributeDetails3').html('<p>'+'<strong> Branch:</strong>'+'<br>' + branchname + '</p>');
                $('#attributeDetails4').html('<p>'+'<strong> Status:</strong>'+'<br>' + status + '</p>');
